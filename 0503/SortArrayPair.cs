...
namespace A092_3_SortArrayPair
{
    ...
    class Program
    {
        ...
        {
            string[] animalsEn = { "dog", "cow", "rabbit", "goat", "sheep", "mouse" }; string[] animalsKo = { "개", "소", "토끼", "염소", "양", "쥐" };
            ...
            Display("After Sort by Korean", animalsEn, animalsKo); IComparer revCom = new ReverseComparer();

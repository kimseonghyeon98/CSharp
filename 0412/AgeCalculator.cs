...
namespace A073_AgeCalculator
{
    class AgeCalculator
    {
        ...
        {
            Console.Write("생일을  입력하세요(yyyy/mm/dd) : "); string birth = Console.ReadLine();
            ...
            // 생년의  생일부터  마지막날까지의  날짜  수  = 365(366) - DayOfYear(bYear, bMonth, bDay) int yearDays = IsLeapYear(bYear) ? 366 : 365; 
